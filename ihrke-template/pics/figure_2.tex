...
\begin{tikzpicture}[
    ...
    % Orient
    \node[phase, below=1.2cm of S1] (P2) {ORIENT\\(Protocol Normalization)};
    ...
    % Decide
    \node[phase, below=1.2cm of S2] (P3) {DECIDE\\(Validation \& Pruning)};
    ...
    % Act
    \node[phase, below=1.2cm of S3] (P4) {ACT\\(Visualization \& Alerting)};
